...
class IndexController extends Controller
{
    public function home(){
        ...
        return view('pages.home')->with(compact('danhmuc','truyen', 'theloai', 'slide_truyen', 'sach'));
    }
    ...
    public function theloai($slug){
        ...
        return view('pages.theloai')->with(compact('danhmuc', 'truyen', 'tentheloai', 'theloai', 'slide_truyen', 'sach'));
    }
    ...
    public function timkiem(){
        ...
        $sach = Sach::with('theloai')->where('tensach', 'LIKE', '%'.$tukhoa.'%')->orWhere('tacgia', 'LIKE', '%'.$tukhoa.'%')->orWhere('tomtat', 'LIKE', '%'.$tukhoa.'%')->get();
