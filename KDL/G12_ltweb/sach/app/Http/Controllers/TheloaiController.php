...
class TheloaiController extends Controller
{
    ...
    public function store(Request $request)
    {
         $data = $request->validate(
            ...
            [
                'tentheloai.unique' => 'Tên danh mục đã tồn tại, vui lòng điền tên khác',
                'slug_theloai.unique' => 'Tên danh mục đã tồn tại, vui lòng điền slug khác',
                'tentheloai.required' => 'Nhập tên danh mục',
