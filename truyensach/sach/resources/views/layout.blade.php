...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <footer class="text-muted">
     ...
     <div id="fb-root"></div>
        ...
        <div id="fb-root"></div>
<script async defer crossorigin="anonymous" src="https://connect.facebook.net/vi_VN/sdk.js#xfbml=1&version=v13.0&appId=4699170143480379&autoLogAppEvents=1" nonce="YzhGFWv6"></script>
