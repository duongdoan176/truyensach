            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{route('sach.store')}}" enctype='multipart/form-data'>
                        ...
                        <input type="text" class="form-control" value = "{{old('email')}}" onkeyup ="ChangeToSlug();" name ="email" id="slug" aria-describedby="emailHelp" placeholder="Email">
                        </div>
                        <div class="form-group">
                        <label for="exampleInputEmail1">Ten sach</label>
                        <input type="text" class="form-control" value = "{{old('tensach')}}" name ="tensach" id="convert_slug" aria-describedby="emailHelp" placeholder="Slug sách">
                        </div>
                        <div class="form-group">
