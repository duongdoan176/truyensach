                    ...
                    <table class="table">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>
                            <a href="{{route('theloai.edit',['theloai'=>$theloai->id])}}" class ='btn btn-primary'>EDIT</a>
                            <form action="{{route('theloai.destroy',['theloai'=>$theloai->id])}}" method="POST">
                                @method('DELETE')
                                @csrf
                                <button onclick="return confirm('Xóa thể loại truyện này')" class = "btn btn-danger">DELETE</button>
