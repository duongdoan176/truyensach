                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{route('truyen.store')}}" enctype='multipart/form-data'>
                        ...
                        <input type="text" class="form-control" value = "{{old('tacgia')}}" name ="tacgia" aria-describedby="emailHelp" placeholder="Tên tác giả">
                         ...
                         <div class="form-group">
                        <label for="exampleInputEmail1">Tác dịch giả</label>
                        <input type="text" class="form-control" value = "{{old('tentacgia')}}" name ="tendichgia" aria-describedby="emailHelp" placeholder="Tên dịch giả">
                        </div>
                        <div class="form-group">
                        <label for="exampleInputEmail1">Nhà xuất bản</label>
                        <input type="text" class="form-control" value = "{{old('nhaxb')}}" name ="nhaxb" aria-describedby="emailHelp" placeholder="Tên dịch giả">
                        </div>
                        
                        <div class="form-group">
                        <label for="exampleInputEmail1">Quốc gia</label>
                        <input type="text" class="form-control" value = "{{old('tacgia')}}" name ="quocgia" aria-describedby="emailHelp" placeholder="Quốc gia">
                        </div>
                        <div class="form-group">
